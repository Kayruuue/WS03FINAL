...
<section>
  <div class="container listings-index-shell mx-auto p-4 mt-3">
    <div class="section-shell">

    <?php loadPartial('message'); ?>

    <!-- Heading: All Jobs or Search Results -->
    <div class="section-heading text-center text-3xl mb-4 font-bold border border-gray-300 p-3">
    ...
    <div class="job-grid grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div class="job-card rounded-lg shadow-md bg-white">
        <div class="job-card-body p-4">
          ...
          <p class="job-description text-gray-700 text-lg mt-2"><?= $listing->description ?></p>
