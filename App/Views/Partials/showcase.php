<!-- Showcase -->
    ...
    >
      ...
      <div class="container mx-auto px-4 text-center z-10">
        ...
        <form method="GET" action="/listings/search" class="mb-3 block mx-5 md:mx-auto">
          <input
            type="text"
            name="keywords"
            placeholder="Keywords"
            class="w-full md:w-auto mb-2 px-3 py-2 border focus:outline-none rounded-lg box-shadow-md"
          />
          <input
            type="text"
            name="location"
